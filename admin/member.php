	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">ຂໍ້ມູນສະມາຊິກ</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="row">
							<div class="col-lg-6">
								<button class="btn btn-primary btn-md" data-toggle="modal" data-target="#modalAddMember"><i class="fa fa-user-plus fa-lg"></i> ເພີ່ມສະມາຊິກ</button>
							</div>
						</div><!--/.row-->
					</div>
