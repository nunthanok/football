	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">ຫົວຫນ່ວຍສິນຄ້າ</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-4">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="col-md-12">
						<i class="fa fa-plus-circle" aria-hidden="true"></i> ເພີ່ມຫົວຫນ່ວຍສິນຄ້າ
						</div>
					</div>
                    ...
                    <form id="add_unit">
                        <div class="form-group">
                            <label for="unit">ຊື່ ຫນ່ວຍສິນຄ້າ</label>
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					<div class="panel-heading">
					<i class="fa fa-list" aria-hidden="true"></i> ລາຍລະອຽດຫນ່ວຍສິນຄ້າ
                    </div>
					<div class="panel-body">
